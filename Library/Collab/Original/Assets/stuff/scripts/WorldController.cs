...
public class WorldController : MonoBehaviour {
	...
	void Move(int xDir, int yDir,GameObject g)
    {
		...
		var stuff = Quaternion.RotateTowards(g.transform.rotation, q, 10f);
		g.transform.rotation = stuff;
		//g.transform.rotation.Set (g.transform.rotation.x, g.transform.rotation.y, g.transform.rotation.z, g.transform.rotation.w-90f);
		Debug.Log (goal);
		//Debug.Log ("x "+g.transform.rotation);
		Debug.Log ("->"+stuff);
	}
